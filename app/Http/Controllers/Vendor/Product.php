...
class Product extends Controller
{
    public function index(Request $request,$id)
    {
        ...
        return view('userVendor.product', compact('products','id','categories'));
    }
    ...
    public function getNew($id){
        $categories=Gategory::all();
        return view('userVendor.addProduct',compact('id','categories'));
    }
    ...
    public function getUpdate($id){
        ...
        return view('userVendor.updateProduct',compact('product','categories'));
    }
