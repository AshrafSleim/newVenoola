            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-2 col-sm-2 col-xs-12 p-l-0 p-r-0" style="float: left; padding-bottom: 10px;">
                        <a  class="btn btn-info" style="background-color: #4b646f" href="{{route('getAddNewProduct',$id)}}" >Add New Product</a>
                    </div>
                    ...
                    <div class="col-md-2 col-sm-6 col-xs-12 lft padding-bb">
                        <div class=" nw-pd col-md-1 col-md-offset-6">
                            <button  class="btn btn-primary border-r"  style="background-color: #4b646f" onclick="applySearch({{route('vendorMarketProduct.index',$id)}})">Search</button>
            ...
            <table  class="table table-striped table-hover table-bordered " >
                ...
                @foreach($products as $product)
                    <tr>
                        ...
                        <th class="rowStyle" ><a href="{{route('getUpdateProduct',$product->id)}}" style="background-color: #4b646f;width: 58px;" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i> Edit</a> <button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#myModaldelete-{{$product->id}}"><i class="fa fa-trash"></i> Delete</button></th>
                    </tr>
                @endforeach
                </tbody>
            </table>
                ...
                <div class="modal-dialog modal-sm "  >
                    ...
                    <div class="modal-content "style="text-align: center;">
                        ...
                        <h4 class="deleteModel">Are you sure you want to delete this</h4>
                            <form method="POST" id="myformdelete" action="{{route('deleteVendorProduct.delete', $product->id)}}">
                                @csrf
