                ...
                <div class="modal-dialog modal-sm "  >
                    ...
                    <div class="modal-content "style="text-align: center;">
                        ...
                        <h4 class="deleteModel">Are you sure you want to delete this</h4>
                            <form method="POST" id="myformdelete" action="{{route('vendordeleteCategory.delete', $category->id)}}">
                                @csrf
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="myforminsert" action="{{route('vendoraddNewCategory')}}" enctype="multipart/form-data">
                        @csrf
