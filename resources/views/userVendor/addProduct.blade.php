...
@section('content')
    ...
    <div class="form-content">
        <form action="{{route('postAddNewProduct',$id)}}"  method="post" class="mb-3 pb-2" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row ">
                <div class="form-group col-md-12 ">
                    ...
                    <a href="{{route('vendorMarketProduct.index',$id)}}" class="btn btn-info" style="background-color: #4b646f">Cancel</a>
                </div>
            </div>
        </form>
