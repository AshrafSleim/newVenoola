            ...
            <div class="modal fade bs-example-modal-sm" id="myModaldelete-{{$market->id}}" role="dialog" aria-labelledby="mySmallModalLabel" >
                <div class="modal-dialog modal-sm "  >
                    ...
                    <div class="modal-content "style="text-align: center;">
                        ...
                        <form method="POST" id="myformdelete" action="{{route('VendorMarket.delete', $market->id)}}">
                            @csrf
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" id="myforminsert" action="{{route('VendorUpdateMarket',$market->id)}}" enctype="multipart/form-data">
                                @csrf
    ...
    <div class="modal fade" id="myModalinsert" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="myforminsert" action="{{route('VendorAddNewMarkets',$id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="name">Market Name</label>
