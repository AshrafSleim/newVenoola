...
@section('content')
    ...
    <div id="slides-shop" class="cover-slides">
        <ul class="slides-container">
            <li class="text-left">
                <img src="{{url('/')}}/siteDesign/images/banner-01.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> Venoola</strong></h1>
                            <a href="{{route('siteFilter')}}" class="btn hvr-hover gift">Get your Gift</a>
            ...
            <li class="text-center">
                <img src="{{url('/')}}/siteDesign/images/banner-02.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> Venoola</strong></h1>
            ...
            <li class="text-right">
                <img src="{{url('/')}}/siteDesign/images/banner-03.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> Venoola</strong></h1>
                ...
                @foreach($products as $product)
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            ...
                            <a class="btn hvr-hover" href="#">{{session()->get('lang') == 'ar' ? $product->nameAr : $product->name}}</a>
                        </div>
                    </div>
                    @endif
                @endforeach
