...
@section('content')
    <div class="row">
        <div class="col-md-6 col-sm-12 col-xs-12 p-l-0 p-r-0 btn-addnew" style="float: left; padding-bottom: 10px;">
            @if(auth()->guard('employee')->user()->addCategory == 'yes')
                ...
                <div class="modal-dialog modal-sm "  >
                    ...
                    <div class="modal-content "style="text-align: center;">
                        ...
                        <h4 class="deleteModel">Are you sure you want to delete this</h4>
                            <form method="POST" id="myformdelete" action="{{route('EmployeedeleteCategory.delete', $category->id)}}">
                                @csrf
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="myforminsert" action="{{route('EmployeeaddNewCategory')}}" enctype="multipart/form-data">
                        @csrf
