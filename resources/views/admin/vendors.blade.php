            ...
            <table  class="table table-striped table-hover table-bordered " >
                ...
                @foreach($users as $user)
                    <tr>
                        ...
                        <th class="rowStyle" style="display:block"><button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#myModaldelete-{{$user->id}}"><i class="fa fa-trash"></i> Delete</button>  <a href="{{route('adminVendorMarket.index',$user->id)}}" style="background-color: #26b1b0" class="btn btn-xs btn-info" ><i class="fa fa-eye"></i> Show</a></th>
                    </tr>
                @endforeach
                </tbody>
            </table>
                ...
                <div class="modal-dialog modal-sm "  >
                    ...
                    <div class="modal-content "style="text-align: center;">
                        ...
                        <h4 class="deleteModel">Are you sure you want to delete this</h4>
                            <form method="POST" id="myformdelete" action="{{route('adminVendor.delete', $user->id)}}">
                                @csrf
