...
@section('content')
    <div class="row">
        <div class="col-md-6 col-sm-12 col-xs-12 p-l-0 p-r-0 btn-addnew" style="float: left; padding-bottom: 10px;">
            <button type="button"  class="btn btn-info border-r" data-toggle="modal" style="background-color: #4b646f" data-target="#myModalinsert">Add New Brand</button>
        </div>
    </div>
    <br>
                ...
                <div class="modal-dialog modal-sm "  >
                    ...
                    <div class="modal-content "style="text-align: center;">
                        ...
                        <h4 class="deleteModel">Are you sure you want to delete this</h4>
                            <form method="POST" id="myformdelete" action="{{route('deleteBrand.delete', $category->id)}}">
                                @csrf
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="myforminsert" action="{{route('addNewBrand')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="nameAr">Brand Name Ar</label>
