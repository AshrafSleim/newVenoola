    ...
    <div class="container" style=" margin-right: auto; margin-left: auto; width:100%;">
        <div class="row" style="width: 100%;text-align: right ">
            ...
            <h4 style="margin-bottom:0; margin-top:0px;font-size: 15px;text-align: right">
                Venoola © Copyrights </h4>
            <h4 style="padding-right: 50px;margin-bottom:0; margin-top:0px;font-size: 15px"><a href="#" target="_blank" style="color:#fff !important; text-decoration:none; margin-bottom:0">Created by tacweed </a></h4>
